...
- I also identified fields not useful in predicting how the exercise was done.  Decided to remove the variables: unique sequential number, user name, timestamps, and window information.
...
- I center and scale the rest of the variables.
\newline
...
- The model identified 26 randomly selected predictors as the combination that resulted in the highest accuracy.
